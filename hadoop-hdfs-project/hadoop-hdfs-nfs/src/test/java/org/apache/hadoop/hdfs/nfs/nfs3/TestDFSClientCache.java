...
public class TestDFSClientCache {
  ...
  @Test
  public void testSecureConfigurationNotRoot() throws IOException {
  ...
  @Test
  public void testSecureConfigurationRoot() throws IOException {
    String userName = DFSClientCache.ROOT_USER;
    String currentUser = "currentUser";
    ...
    DFSClientCache cache = new DFSClientCache(conf);
    UserGroupInformation ugiResult
            = cache.getUserGroupInformation(
                                      userName,
                                      true,
                                      currentUserUgi);

    assertThat(ugiResult.getUserName(), is(currentUser));
    assertThat(ugiResult, is(currentUserUgi));
    assertThat(
            ugiResult.getAuthenticationMethod(),
            is(UserGroupInformation.AuthenticationMethod.KERBEROS));
  }
